...
('user1', 1, 42, 10, 3, '安定してきた', '2026-06-06'),
('user1', 1, 42, 8, 3, 'フォーム安定', '2026-06-07'),
('user1', 1, 42, 9, 3, '胸に効く', '2026-06-08'),
('user1', 1, 42, 10, 3, '効いてる', '2026-06-09'),
('user1', 1, 42, 8, 3, '肩の調子◎', '2026-06-10'),
('user1', 1, 42, 7, 3, '疲労気味', '2026-06-11'),
('user1', 1, 42, 9, 3, '持ち直した', '2026-06-12'),
('user1', 1, 42, 8, 3, 'フォーム良好', '2026-06-13'),
('user1', 1, 42, 10, 3, '調子良い', '2026-06-14'),
('user1', 1, 42, 8, 3, '安定してきた', '2026-06-15'),
('user1', 1, 42, 9, 3, '胸パンパン', '2026-06-16'),
('user1', 1, 42, 10, 3, '効いてる', '2026-06-17'),
('user1', 1, 42, 8, 3, 'フォーム安定', '2026-06-18'),
('user1', 1, 42, 7, 3, '疲労あり', '2026-06-19'),
('user1', 1, 42, 9, 3, '持ち直した', '2026-06-20'),
('user1', 1, 42, 10, 3, '胸に効く', '2026-06-21'),
('user1', 1, 42, 8, 3, '安定してきた', '2026-06-22'),
('user1', 1, 42, 9, 3, '効いてる', '2026-06-23'),
('user1', 1, 42, 8, 3, 'フォーム良好', '2026-06-24'),
('user1', 1, 42, 7, 3, '疲労気味', '2026-06-25'),
('user1', 1, 42, 9, 3, '持ち直した', '2026-06-26'),
('user1', 1, 42, 10, 3, '調子良い', '2026-06-27'),
('user1', 1, 42, 8, 3, '胸パンパン', '2026-06-28'),
('user1', 1, 42, 9, 3, '仕上げ', '2026-06-29'),
('user1', 1, 42, 10, 3, '月末ラスト', '2026-06-30'),
...
('「そら豆」を食べると、脂肪燃焼のエンジンがかかる'),
('大豆ファーストは「脂肪の吸収」に先手を打つ'),
('小豆（あずき）は「むくみ」を撃退する天然の利尿薬'),
('筋肉は「天然のNO.1若返り薬」を分泌している'),
('「筋肉痛」がなくても、筋肉はちゃんと育っている'),
('体の中で一番「エネルギーを消費する筋肉」は、太ももである'),
('筋肉は水分を含んだ「スポンジ」である'),
('筋トレするほど太りにくくなる'),
('筋トレの後に「笑う」と、筋肉の回復が早まる'),
('辛いものを食べても、脂肪は勝手には燃えない'),
('「体重」は、サウナや半身浴では1グラムも減っていない'),
('「鏡」を見ながら食事をすると、ジャンクフードの量が減る'),
('「ガム」を噛みながら歩くだけで、消費カロリーがアップする');
