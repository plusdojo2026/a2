...
(15, '死ぬ気でやれよ、死なないから。'),
(16, '今日できることを明日に延ばすな。明日が来る保証などどこにもないのだから。'),
(17, '『もう限界だ』と思ってから、あと2回上げろ。その2回が、明日の新しいお前を作る。'),
(18, 'ウエイト（重り）が重いんじゃない。お前の覚悟が軽いんだ。'),
(19, 'ジムに行くまでが一番重い。行ってしまえば、あとは挙げるだけだ。'),
(20, 'ウエイトが重いんじゃない。覚悟が軽いんだ。'),
(21, 'トレーニングとは、自分との対話であり、自分との戦争だ。鏡に映る自分に勝て。'),
(22, '迷ったら、重い方を挙げろ。'),
(23, '限界は、脳が作った幻だ。'),
(24, '明日やろうは、バカヤロウだ。'),
(25, 'NO PAIN, NO GAIN.（痛みなくして、得るものなし）'),
(26, 'やらない理由は、探せば無限にある。'),
(27, '言い訳は、カロリーを消費しない。'),
(28, '自分に勝てない奴が、誰に勝てる？'),
(29, '筋肉は、一日にして成らず。'),
