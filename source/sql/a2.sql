...
('user1', 1, 30, 10, 3, '安定してきた', '2026-06-06'),
('user1', 1, 30, 8, 3, 'フォーム安定', '2026-06-07'),
('user1', 1, 30, 9, 3, '胸に効く', '2026-06-08'),
('user1', 1, 30, 10, 3, '効いてる', '2026-06-09'),
('user1', 1, 30, 8, 3, '肩の調子◎', '2026-06-10'),
('user1', 1, 30, 7, 3, '疲労気味', '2026-06-11'),
('user1', 1, 30, 9, 3, '持ち直した', '2026-06-12'),
('user1', 1, 30, 8, 3, 'フォーム良好', '2026-06-13'),
('user1', 1, 30, 10, 3, '調子良い', '2026-06-14'),
('user1', 1, 30, 8, 3, '安定してきた', '2026-06-15'),
('user1', 1, 30, 9, 3, '胸パンパン', '2026-06-16'),
('user1', 1, 30, 10, 3, '効いてる', '2026-06-17'),
('user1', 1, 30, 8, 3, 'フォーム安定', '2026-06-18'),
('user1', 1, 30, 7, 3, '疲労あり', '2026-06-19'),
('user1', 1, 30, 9, 3, '持ち直した', '2026-06-20'),
('user1', 1, 30, 10, 3, '胸に効く', '2026-06-21'),
('user1', 1, 30, 8, 3, '安定してきた', '2026-06-22'),
('user1', 1, 30, 9, 3, '効いてる', '2026-06-23'),
('user1', 1, 30, 8, 3, 'フォーム良好', '2026-06-24'),
('user1', 1, 30, 7, 3, '疲労気味', '2026-06-25'),
('user1', 1, 30, 9, 3, '持ち直した', '2026-06-26'),
('user1', 1, 30, 10, 3, '調子良い', '2026-06-27'),
('user1', 1, 30, 8, 3, '胸パンパン', '2026-06-28'),
('user1', 1, 30, 9, 3, '仕上げ', '2026-06-29'),
('user1', 1, 30, 10, 3, '月末ラスト', '2026-06-30'),
